  ...
  return (
    <div className="pt-32 pb-20">
      <section className="container mx-auto px-6">
        <SectionHeading
          eyebrow="Services"
          title={<>What we <span className="gradient-text">build</span>.</>}
        ...
        <div className="mt-24 max-w-3xl mx-auto text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            Most of our clients run a combined content engine across all four
            services. Let's design the right rhythm for your brand.
          </p>
          <Link
            to="/contact"
