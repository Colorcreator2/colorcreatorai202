...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-JIKzvmMk.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BQOOUiiF.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "colorcreatorai202";
var SERVER_FN_BASE = "/colorcreatorai202/_serverFn/";
