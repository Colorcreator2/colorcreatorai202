...
const appCss = "/colorcreatorai202/assets/styles-Cl_9iTMY.css";
...
const logo = "/colorcreatorai202/assets/logo-B-VHpKdh.png";
const links = [
  { to: "/", label: "Home" },
    ...
    "header",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `flex items-center justify-between rounded-2xl px-5 py-3 transition-all duration-500 ${scrolled ? "glass-strong shadow-elevated" : "bg-transparent"}`,
            children: [
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden mt-2 glass-strong rounded-2xl p-4 animate-fade-up", children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-1", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to: l.to,
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "relative border-t border-white/5 mt-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-12 md:grid-cols-3 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-sm", children: "AI-powered creative content studio. We build the visual presence of modern brands." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 md:items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3 mt-2", children: [
        ...
        ].map(({ icons: Icon2, href }, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href,
            target: "_blank",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:text-right", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground", children: "Available worldwide" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground mt-1", children: "Booking Q1 — Q2 projects" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between gap-4 text-xs text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Color-Creator AI. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Crafted with cinematic intent." })
    ] })
  ] }) });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pointer-events-none fixed inset-0 -z-10 overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          background: "radial-gradient(circle, #3DA9FC, transparent 70%)",
          filter: "blur(90px)"
        }
      }
    )
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NotFoundComponent, {}) }) });
}
const Route$7 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Color-Creator AI is an AI-powered creative content studio crafting graphics, photography, and cinematic AI video for modern brands."
      },
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {})
  ] });
}
const $$splitComponentImporter$6 = () => import("./services-Czkj_0M2.js");
const Route$6 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Graphic design, photography, AI video production and full content systems for modern brands."
    }, {
      property: "og:title",
      content: "Services — Color-Creator AI"
    }, {
      property: "og:description",
      content: "Creative content services by Color-Creator AI."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const cowbellHero = "/colorcreatorai202/assets/cowbell-hero-dBvu8c7b.jpeg";
const cowbellEffortless = "/colorcreatorai202/assets/cowbell-effortless-DlxYnfRu.jpeg";
const cowbellCreamy = "/colorcreatorai202/assets/cowbell-creamy-BLW8Iqmi.jpeg";
const nilaxHero = "/colorcreatorai202/assets/nilax-hero-RMe7Y94p.jpeg";
const nilaxLifestyle = "/colorcreatorai202/assets/nilax-lifestyle-Dwp-4Az0.jpeg";
const maltinaHero = "/colorcreatorai202/assets/maltina-hero-W0-pgVj7.jpeg";
const caseStudies = [
  {
    ...
    summary: "A warm, family-first visual campaign celebrating the everyday joy of Cowbell Chocolate — built around hero pack-shots, lifestyle moments and bold typographic posters for social and retail.",
    hero: cowbellHero,
    deliverables: [
    ...
    approach: {
      objective: "Cowbell wanted to refresh their flagship chocolate drink with a campaign that felt warm, premium and unmistakably family-oriented across every touchpoint.",
      direction: "We anchored the system on rich chocolate browns and the brand's signature orange, paired with cinematic product photography and intimate lifestyle moments. The typography was kept bold and playful to land emotion fast on a small screen.",
      impact: "The new visual system gave Cowbell a coherent look across retail, social and OOH — lifting recall in feed and giving the sales team premium-feeling assets that finally matched the quality of the product."
    }
  },
  {
    slug: "fbc-nilax",
    ...
    summary: "A futuristic launch system for FBC Nilax Acne Control face wash — combining a hero CGI-style product visual with real lifestyle photography of customers experiencing the product.",
    hero: nilaxHero,
    deliverables: [
    ...
    approach: {
      objective: "Launch FBC Nilax into a crowded skincare market with a visual identity that felt clinical, premium and emotionally desirable — without leaning on stock photography.",
      direction: "We built a deep-violet visual world for the hero product story, then balanced it with bright, naturally-lit lifestyle photography so the brand felt both scientific and human.",
      impact: "The dual-track system gave FBC a launch toolkit that performed equally well on premium retail placements and high-velocity social ads."
    }
  },
  {
    ...
    summary: "A bold, splash-driven product campaign for Maltina Classic — engineered to make the bottle feel cinematic, premium and unmistakably refreshing in every frame.",
    hero: maltinaHero,
    deliverables: [
    ...
    approach: {
      objective: "Reposition the classic Maltina bottle as a premium, modern refreshment hero that could anchor a full marketing campaign.",
      direction: "We lit the bottle against a moody amber backdrop and built a controlled liquid splash around it to sell motion, freshness and craft in a single frame.",
      impact: "The hero frame became the campaign's centrepiece, scaling cleanly from billboard down to a 1:1 social tile without losing impact."
    }
  }
];
...
const $$splitComponentImporter$5 = () => import("./portfolio-IsaXrOgv.js");
const Route$5 = createFileRoute("/portfolio")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Selected campaigns spanning graphic design, brand photography, AI video and full content production."
    }, {
      property: "og:title",
      content: "Portfolio — Color-Creator AI"
    }, {
      property: "og:description",
      content: "Selected creative campaigns by Color-Creator AI."
    }, {
      property: "og:image",
      content: featuredCaseStudy.hero
    }, {
      name: "twitter:image",
      content: featuredCaseStudy.hero
    }]
...
const $$splitComponentImporter$4 = () => import("./contact-C7c_wX0c.js");
const Route$4 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Tell us about your brand and the content you need. We take on a limited number of projects each quarter."
    }, {
      property: "og:title",
      content: "Start a Project — Color-Creator AI"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$3 = () => import("./about-CTZ-DFWS.js");
const Route$3 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Color-Creator AI is a creative content studio fusing AI production with human creative direction."
    }, {
      property: "og:title",
      content: "About — Color-Creator AI"
    }, {
      property: "og:description",
      content: "A creative studio fusing AI production with human direction."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./VideoSection-BDLltp_I.js");
const Route$2 = createFileRoute("/VideoSection")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-C4ulU_RZ.js");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Cinematic AI video, premium photography and high-volume marketing graphics for brands ready to dominate attention."
    }, {
      property: "og:title",
      content: "Color-Creator AI — AI Creative Content Studio"
    }, {
      property: "og:description",
      content: "AI-powered visual content studio for modern brands."
    }, {
      property: "og:image",
      content: featuredCaseStudy.hero
    }, {
...
const $$splitComponentImporter = () => import("./case-study._slug-BxMYb2DX.js");
const $$splitErrorComponentImporter = () => import("./case-study._slug-BSLpg_8e.js");
const $$splitNotFoundComponentImporter = () => import("./case-study._slug-Bhjbcfb9.js");
const Route2 = createFileRoute("/case-study/$slug")({
  loader: ({
    params
  }) => {
  ...
  head: ({
    ...
    if (!s) return {
      meta: [{
        title: "Case Study — Color-Creator AI"
      }]
    };
    return {
      meta: [{
...
const VideoSectionRoute = Route$2.update({
  id: "/VideoSection",
  path: "/VideoSection",
  getParentRoute: () => Route$7
});
...
const CaseStudySlugRoute = Route2.update({
  id: "/case-study/$slug",
...
export {
  ...
  nilaxLifestyle as d,
  cowbellEffortless as e,
  featuredCaseStudy as f,
  logo as l,
  maltinaHero as m,
  nilaxHero as n,
  router as r
