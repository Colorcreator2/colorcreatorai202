...
function VideoSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "w-full bg-black py-20 px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6", children: videos.map((src, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/30 group-hover:bg-black/10 transition" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-2xl border border-white/10 group-hover:border-white/30 transition" })
      ]
    },
    i
  )) }) });
